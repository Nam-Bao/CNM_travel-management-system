    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md min-h-full">
            <div className="flex justify-between items-center mb-6 pb-4 border-b">
                <h2 className="text-2xl font-bold text-gray-800">🗂️ Quản lý Danh sách Tour</h2>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center">
                                            <div className="h-10 w-10 flex-shrink-0">
                                                <img className="h-10 w-10 rounded-md object-cover border" src={tour.image_url || 'https://via.placeholder.com/150'} alt="" />
                                            </div>
                                            <div className="ml-4">
                                                <div className="text-sm font-bold text-gray-900 truncate w-48" title={tour.title}>{tour.title}</div>
                                                <div className="text-sm text-gray-500">{new Date(tour.start_date).toLocaleDateString('vi-VN')}</div>
                                            </div>
                                        </div>
                                    </td>
